...
<head>
    ...
    <title>Lernie - Email Verifiëren</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 pb-12">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <div class="mb-4 text-center">
                 <h2 class="text-2xl font-bold text-gray-900">Email Verifiëren</h2>
            </div>

            <div class="mb-4 text-sm text-gray-600">
                {{ __('Bedankt voor je registratie! Voordat je begint, kun je je e-mailadres verifiëren door op de link te klikken die we zojuist naar je hebben gestuurd? Als je de e-mail niet hebt ontvangen, sturen we je graag een nieuwe.') }}
            </div>
