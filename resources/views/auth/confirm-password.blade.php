...
<head>
    ...
    <title>Lernie - Bevestig Wachtwoord</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 pb-12">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <div class="mb-4 text-center">
                 <h2 class="text-2xl font-bold text-gray-900">Bevestig Wachtwoord</h2>
            </div>
            <div class="mb-4 text-sm text-gray-600">
                {{ __('Dit is een beveiligd gedeelte van de applicatie. Bevestig je wachtwoord voordat je verdergaat.') }}
            </div>
