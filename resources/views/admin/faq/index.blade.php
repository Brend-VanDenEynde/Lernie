            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-end mb-4 gap-2">
                        <a href="{{ route('admin.faq.categories.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                            Categorieën Beheren
                        </a>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">{{ $faq->category->name ?? 'Onbekend' }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.faq.edit', $faq) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Bewerken</a>
                                    <form action="{{ route('admin.faq.destroy', $faq) }}" method="POST" class="inline-block" onsubmit="return confirm('Weet je zeker dat je deze vraag wilt verwijderen?');">
                                        @csrf
                                        @method('DELETE')
