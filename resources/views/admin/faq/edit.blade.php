                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.faq.update', $faq) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="answer" name="answer" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="5" required>{{ old('answer', $faq->answer) }}</textarea>
